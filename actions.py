...
def send_order(data):
    ...
    if position_side == 'None' and data['side']=='Buy' and data['takeProfit']!='None' and data['stopLoss']!='None' and data['trailingStop']=='None':
        ...
        qty = tr_amnt, price=takeprofit,time_in_force='PostOnly')
    ...
    if position_side == 'None' and data['side']=='Buy' and data['takeProfit']=='None' and data['stopLoss']!='None' and data['trailingStop']=='None':
        ...
        print('Sending Order in ', data['side'],'position')
        order_resp = bybit1.place_active_order(side=data['side'], symbol=data['symbol'], order_type=data['type'], qty=orderamount,time_in_force='PostOnly')
        ...
        print('Sending Order in ', data['side'],'position')
        order_resp = bybit1.place_active_order(side=data['side'], symbol=data['symbol'], order_type=data['type'],
        qty = tr_amnt, time_in_force='PostOnly')
    ...
    if position_side == 'None' and data['side']=='Sell' and data['takeProfit']=='None' and data['stopLoss']!='None' and data['trailingStop']=='None':  
        ...
        order_ids = order_resp['result']['order_id'] if order_resp['result'] else None
        print(order_ids)
        print('ret_msg1ret_msg1ret_msg1ret_msg1ret_msg1ret_msg1ret_msg1ret_msg1ret_msg1ret_msg1ret_msg1')
    ...
    if position_side == 'None' and data['side']=='Sell' and data['takeProfit']!='None' and data['stopLoss']=='None' and data['trailingStop']=='None':  
        ...
        print('Sending Order in ', data['side'],'position')
        order_resp = bybit1.place_active_order(side=data['side'], symbol=data['symbol'], order_type=data['type'],
        qty = tr_amnt, price=takeprofit,time_in_force='PostOnly', reduce_only=True)
    ...
    if position_side == 'None' and data['side']=='Sell' and data['takeProfit']=='None' and data['stopLoss']=='None' and data['trailingStop']=='None':  
        ...
        print(tr_amnt)
        order_resp = bybit1.place_active_order(side=data['side'], symbol=data['symbol'], order_type=data['type'], qty=tr_amnt,time_in_force='PostOnly', reduce_only=False)
        print('order_resporder_resporder_resporder_resporder_resporder_resporder_resporder_resporder_resporder_resporder_resp')
        print(order_resp)
        ...
        print('iyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy')
